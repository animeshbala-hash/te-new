...
function Hero() {
  return (
    <div id="contact-hero" style={{ position: "relative", minHeight: "75vh", display: "flex", alignItems: "center", overflow: "hidden", paddingTop: 64 }}>
      ...
      <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to right, rgba(60,78,20,0.55) 0%, rgba(60,78,20,0.20) 60%, transparent 100%)" }} />
