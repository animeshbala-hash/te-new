        ...
        <div style={{ marginTop: 44, background: ACCENT, borderRadius: 20, padding: "48px 52px", position: "relative", overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 32 }}>
          ...
          <div style={{ position: "relative", zIndex: 1, flexShrink: 0 }}>
            <a
              ...
              style={{ display: "inline-flex", alignItems: "center", gap: 10, background: NAVY, color: "#fff", padding: "16px 24px", borderRadius: 14, fontFamily: FONT, fontSize: 14, fontWeight: 800, textDecoration: "none", transition: "transform 0.2s" }}
