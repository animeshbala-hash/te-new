...
const S_MID_BLUE   = "#3B7ABD";   // Melghat — slightly darker blue
const S_PURPLE     = "#5B21B6";   // Beyond the Boardroom — purple
...
export const IMPACT_STORIES: ImpactStory[] = [
  {
    slug: "iave-ivy-2026",
    title: "Building the Global Stage for Volunteering",
    subtitle: "TCS ProEngagers build and launch IAVE's Call to Action platform for IVY 2026",
    ...
    sections: [
      ...
      {
        body: "The IAVE Global Action Mapping Platform was launched on 12 May 2026 — the first time the global volunteering community will have a shared place to see, in one view, the actions being taken to advance Recognition, Support, and Safeguarding for volunteers worldwide. The platform serves as a central digital anchor for IVY 2026, supporting participation, visibility, and long-term momentum for volunteering worldwide.",
        image: iaveIvy26Img3,
      },
    ],
    ...
    stats: [
      { num: "100+", label: "Countries in IAVE network" },
      { num: "1970", label: "IAVE established" },
      { num: "2018–19", label: "IAVE Best Global Volunteer Program — Tata Engage" },
    ],
    featured: true,
    slideHeadline: "Building the Global Stage for Volunteering",
    slideSub: "Built by TCS ProEngagers for IAVE · Launched 12 May 2026",
  },
  {
    slug: "wayanad-2024",
